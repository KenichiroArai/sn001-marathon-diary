package kmg.sn.sn001.dbflute.allcommon;
 ...
 */
@Configuration
@ComponentScan(value="kmg.sn.sn001.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    protected DBFluteInitializer newDBFluteInitializer(DataSource dataSource) {
        return new kmg.sn.sn001.dbflute.allcommon.DBFluteInitializer(dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new kmg.sn.sn001.dbflute.allcommon.ImplementedInvokerAssistant();
    }
